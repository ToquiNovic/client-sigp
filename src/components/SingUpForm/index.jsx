...
import { setTipoSeleccionado } from '../../redux/features/TipoIDSlice';
...
const SingUpForm = () => {
  ...
  const validarFormulario = () => {
    if (!!nombre1 || !!apellido1 || !!numerodni || !!correo  || !!password) {
    ...
    <div>
      ...
      >
        <form onSubmit={handleSubmit} className={styles.content}>
          ...
          />
          <TextField label="Segundo Nombre"
          value={nombre2}
          ...
          <TextField label="Numero de Identificaion"
          value={numerodni}
